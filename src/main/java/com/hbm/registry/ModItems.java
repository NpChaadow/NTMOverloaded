...
/**
 * HBM's Nuclear Tech - Complete Item Registry (1.20.1 Forge Port)
 *
 * All 1,865 items from the original 1.7.10 ModItems.java are registered here
 * as plain Item instances. Custom item classes (weapons, armor, tools, RBMK
 * rods, food, etc.) must be ported separately and substituted in over time.
 *
 * Registry keys exactly match the original unlocalizedNames so that lang files,
 * recipes, and other references remain compatible.
 *
 * NOTE: The original source had three items erroneously sharing the key
 * "uranium_ingot". They have been given unique keys here:
 *   ingot_uranium  -> "ingot_uranium"
 *   ingot_u233     -> "ingot_u233"
 *   ingot_u235     -> "ingot_u235"
 */
public class ModItems {
    ...
    public static final RegistryObject<Item> AMMO_BAG =
            ITEMS.register("ammo_bag", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> AMMO_BAG_INFINITE =
            ITEMS.register("ammo_bag_infinite", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> AMMO_FIREEXT =
            ITEMS.register("ammo_fireext", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> AMMO_MISC =
            ITEMS.register("ammo_misc", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> AMMO_SHELL =
            ITEMS.register("ammo_shell", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> AMS_CATALYST_BLANK =
            ITEMS.register("ams_catalyst_blank", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> BATTERY_PACK =
            ITEMS.register("battery_pack", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> BATTERY_SC =
            ITEMS.register("battery_sc", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> BLUEPRINT_FOLDER =
            ITEMS.register("blueprint_folder", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> BLUEPRINTS =
            ITEMS.register("blueprints", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> CANNED_CONSERVE =
            ITEMS.register("canned_conserve", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> CIRCUIT_STAR_COMPONENT =
            ITEMS.register("circuit_star_component", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> CIRCUIT_STAR_PIECE =
            ITEMS.register("circuit_star_piece", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> CONVEYOR_WAND =
            ITEMS.register("conveyor_wand", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> FLUID_PACK_EMPTY =
            ITEMS.register("fluid_pack_empty", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> FLUID_PACK_FULL =
            ITEMS.register("fluid_pack_full", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> GUN_AMAT =
            ITEMS.register("gun_amat", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> GUN_AMAT_PENANCE =
            ITEMS.register("gun_amat_penance", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> GUN_AMAT_SUBTLETY =
            ITEMS.register("gun_amat_subtlety", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> GUN_AUTOSHOTGUN =
            ITEMS.register("gun_autoshotgun", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> GUN_AUTOSHOTGUN_HERETIC =
            ITEMS.register("gun_autoshotgun_heretic", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> GUN_CHARGE_THROWER =
            ITEMS.register("gun_charge_thrower", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> GUN_DRILL =
            ITEMS.register("gun_drill", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> GUN_G3_ZEBRA =
            ITEMS.register("gun_g3_zebra", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> GUN_HENRY_LINCOLN =
            ITEMS.register("gun_henry_lincoln", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> GUN_LASER_PISTOL =
            ITEMS.register("gun_laser_pistol", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> GUN_LASER_PISTOL_MORNING_GLORY =
            ITEMS.register("gun_laser_pistol_morning_glory", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> GUN_LASER_PISTOL_PEW_PEW =
            ITEMS.register("gun_laser_pistol_pew_pew", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> GUN_MINIGUN_DUAL =
            ITEMS.register("gun_minigun_dual", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> GUN_N_I_4_N_I =
            ITEMS.register("gun_n_i_4_n_i", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> GUN_PA_MELEE =
            ITEMS.register("gun_pa_melee", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> GUN_PA_RANGED =
            ITEMS.register("gun_pa_ranged", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> GUN_STAR_F =
            ITEMS.register("gun_star_f", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> GUN_STAR_F_AKIMBO =
            ITEMS.register("gun_star_f_akimbo", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> INGOT_MERCURY = //IT'S TO PREVENT ANY AMBIGUITY, AS IT WAS TREATED AS A FULL INGOT IN THE PAST ANYWAY =
            ITEMS.register("ingot_mercury", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> INGOT_METAL =
            ITEMS.register("ingot_metal", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> ITEM_EXPENSIVE =
            ITEMS.register("item_expensive", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> LEGACY_TOOLBOX =
            ITEMS.register("legacy_toolbox", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> NCRPA_BOOTS =
            ITEMS.register("ncrpa_boots", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> NCRPA_HELMET =
            ITEMS.register("ncrpa_helmet", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> NCRPA_LEGS =
            ITEMS.register("ncrpa_legs", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> NCRPA_PLATE =
            ITEMS.register("ncrpa_plate", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> ORE_ENRICHED = //FINAL STAGE =
    ...
    public static final RegistryObject<Item> PCH = //FOR COMPAT PLEASE DO NOT HIT ME =
    ...
    public static final RegistryObject<Item> PWR_PRINTER =
            ITEMS.register("pwr_printer", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> RANGEFINDER =
            ITEMS.register("rangefinder", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_BALEFIRE =
            ITEMS.register("rbmk_fuel_balefire", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_BALEFIRE_GOLD =
            ITEMS.register("rbmk_fuel_balefire_gold", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_DRX =
            ITEMS.register("rbmk_fuel_drx", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> RBMK_FUEL_FLASHLEAD =
            ITEMS.register("rbmk_fuel_flashlead", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_HEA241 =
            ITEMS.register("rbmk_fuel_hea241", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_HEA242 =
            ITEMS.register("rbmk_fuel_hea242", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_HEAUS =
            ITEMS.register("rbmk_fuel_heaus", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_HEN =
            ITEMS.register("rbmk_fuel_hen", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_HEP239 =
            ITEMS.register("rbmk_fuel_hep239", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_HEP241 =
            ITEMS.register("rbmk_fuel_hep241", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_HES =
            ITEMS.register("rbmk_fuel_hes", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_HEU233 =
            ITEMS.register("rbmk_fuel_heu233", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_HEU235 =
            ITEMS.register("rbmk_fuel_heu235", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_LEA =
            ITEMS.register("rbmk_fuel_lea", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_LEAUS =
            ITEMS.register("rbmk_fuel_leaus", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_LEP =
            ITEMS.register("rbmk_fuel_lep", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_LES =
            ITEMS.register("rbmk_fuel_les", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_MEA =
            ITEMS.register("rbmk_fuel_mea", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_MEN =
            ITEMS.register("rbmk_fuel_men", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_MEP =
            ITEMS.register("rbmk_fuel_mep", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_MES =
            ITEMS.register("rbmk_fuel_mes", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_MEU =
            ITEMS.register("rbmk_fuel_meu", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_MOX =
            ITEMS.register("rbmk_fuel_mox", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_PO210BE =
            ITEMS.register("rbmk_fuel_po210be", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_PU238BE =
            ITEMS.register("rbmk_fuel_pu238be", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_RA226BE =
            ITEMS.register("rbmk_fuel_ra226be", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_TEST =
            ITEMS.register("rbmk_fuel_test", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_THMEU =
            ITEMS.register("rbmk_fuel_thmeu", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_UEU =
            ITEMS.register("rbmk_fuel_ueu", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_ZFB_AM_MIX =
            ITEMS.register("rbmk_fuel_zfb_am_mix", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_ZFB_BISMUTH =
            ITEMS.register("rbmk_fuel_zfb_bismuth", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_FUEL_ZFB_PU241 =
            ITEMS.register("rbmk_fuel_zfb_pu241", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> RBMK_PELLET_BALEFIRE =
            ITEMS.register("rbmk_pellet_balefire", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_BALEFIRE_GOLD =
            ITEMS.register("rbmk_pellet_balefire_gold", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_DRX =
            ITEMS.register("rbmk_pellet_drx", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_FLASHLEAD =
            ITEMS.register("rbmk_pellet_flashlead", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_HEA241 =
            ITEMS.register("rbmk_pellet_hea241", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_HEA242 =
            ITEMS.register("rbmk_pellet_hea242", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_HEAUS =
            ITEMS.register("rbmk_pellet_heaus", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_HEN =
            ITEMS.register("rbmk_pellet_hen", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_HEP239 =
            ITEMS.register("rbmk_pellet_hep239", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_HEP241 =
            ITEMS.register("rbmk_pellet_hep241", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_HES =
            ITEMS.register("rbmk_pellet_hes", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_HEU233 =
            ITEMS.register("rbmk_pellet_heu233", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_HEU235 =
            ITEMS.register("rbmk_pellet_heu235", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_LEA =
            ITEMS.register("rbmk_pellet_lea", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_LEAUS =
            ITEMS.register("rbmk_pellet_leaus", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_LEP =
            ITEMS.register("rbmk_pellet_lep", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_LES =
            ITEMS.register("rbmk_pellet_les", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_MEA =
            ITEMS.register("rbmk_pellet_mea", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_MEN =
            ITEMS.register("rbmk_pellet_men", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_MEP =
            ITEMS.register("rbmk_pellet_mep", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_MES =
            ITEMS.register("rbmk_pellet_mes", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_MEU =
            ITEMS.register("rbmk_pellet_meu", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_MOX =
            ITEMS.register("rbmk_pellet_mox", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_PO210BE =
            ITEMS.register("rbmk_pellet_po210be", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_PU238BE =
            ITEMS.register("rbmk_pellet_pu238be", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_RA226BE =
            ITEMS.register("rbmk_pellet_ra226be", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_THMEU =
            ITEMS.register("rbmk_pellet_thmeu", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_UEU =
            ITEMS.register("rbmk_pellet_ueu", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_ZFB_AM_MIX =
            ITEMS.register("rbmk_pellet_zfb_am_mix", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_ZFB_BISMUTH =
            ITEMS.register("rbmk_pellet_zfb_bismuth", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> RBMK_PELLET_ZFB_PU241 =
            ITEMS.register("rbmk_pellet_zfb_pu241", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> REBAR_PLACER =
            ITEMS.register("rebar_placer", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> ROD_ZIRNOX =
            ITEMS.register("rod_zirnox", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> T51_BOOTS =
            ITEMS.register("t51_boots", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> T51_HELMET =
            ITEMS.register("t51_helmet", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> T51_LEGS =
            ITEMS.register("t51_legs", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> T51_PLATE =
            ITEMS.register("t51_plate", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> TAURUN_BOOTS =
            ITEMS.register("taurun_boots", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> TAURUN_HELMET =
            ITEMS.register("taurun_helmet", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> TAURUN_LEGS =
            ITEMS.register("taurun_legs", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> TAURUN_PLATE =
            ITEMS.register("taurun_plate", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> WEAPON_MOD_CALIBER =
            ITEMS.register("weapon_mod_caliber", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> WEAPON_MOD_GENERIC =
            ITEMS.register("weapon_mod_generic", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> WEAPON_MOD_SPECIAL =
            ITEMS.register("weapon_mod_special", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> WEAPON_MOD_TEST =
            ITEMS.register("weapon_mod_test", () -> new Item(new Item.Properties()));
    ...
    // ─────────────────────────────────────────────────────────────────────────
    // DEPRECATED — kept for world save compatibility
    // ─────────────────────────────────────────────────────────────────────────
    @Deprecated
