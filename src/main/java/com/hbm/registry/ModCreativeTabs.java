    ...
    public static final RegistryObject<CreativeModeTab> BLOCK_TAB =
            TABS.register("blocks", () -> CreativeModeTab.builder()
                    ...
                    .displayItems((params, output) -> {
                        output.accept(ModFluids.ACID_BUCKET.get());
                        output.accept(ModFluids.CORIUM_BUCKET.get());
                        output.accept(ModFluids.MUD_BUCKET.get());
                        output.accept(ModFluids.RAD_LAVA_BUCKET.get());
                        output.accept(ModFluids.SCHRABIDIC_BUCKET.get());
                        output.accept(ModFluids.TOXIC_BUCKET.get());
                        output.accept(ModFluids.VOLCANIC_BUCKET.get());
                        ...
                        output.accept(ModBlocks.ASPHALT_LIGHT.get());
                        ...
                        output.accept(ModBlocks.BLOCK_C4.get());
                        output.accept(ModBlocks.BLOCK_CADMIUM.get());
                        output.accept(ModBlocks.BLOCK_CAP.get());
                        output.accept(ModBlocks.BLOCK_CDALLOY.get());
                        ...
                        output.accept(ModBlocks.BLOCK_COPPER.get());
                        ...
                        output.accept(ModBlocks.BLOCK_GRAPHITE_DETECTOR.get());
                        output.accept(ModBlocks.BLOCK_GRAPHITE_DRILLED.get());
                        output.accept(ModBlocks.BLOCK_GRAPHITE_FUEL.get());
                        output.accept(ModBlocks.BLOCK_GRAPHITE_LITHIUM.get());
                        ...
                        output.accept(ModBlocks.BLOCK_GRAPHITE_TRITIUM.get());
                        ...
                        output.accept(ModBlocks.BLOCK_TCALLOY.get());
                        ...
                        output.accept(ModBlocks.BLOCK_WASTE.get());
                        output.accept(ModBlocks.BLOCK_WASTE_PAINTED.get());
                        output.accept(ModBlocks.BLOCK_WASTE_VITRIFIED.get());
                        ...
                        output.accept(ModBlocks.BRICK_CONCRETE.get());
                        output.accept(ModBlocks.BRICK_CONCRETE_MOSSY.get());
                        output.accept(ModBlocks.CLUSTER_ALUMINIUM.get());
                        output.accept(ModBlocks.CLUSTER_COPPER.get());
                        output.accept(ModBlocks.CLUSTER_DEPTH_IRON.get());
                        output.accept(ModBlocks.CLUSTER_DEPTH_TITANIUM.get());
                        output.accept(ModBlocks.CLUSTER_DEPTH_TUNGSTEN.get());
                        output.accept(ModBlocks.CLUSTER_IRON.get());
                        output.accept(ModBlocks.CLUSTER_TITANIUM.get());
                        output.accept(ModBlocks.CONCRETE.get());
                        output.accept(ModBlocks.CONCRETE_ASBESTOS.get());
                        output.accept(ModBlocks.CONCRETE_PILLAR.get());
                        output.accept(ModBlocks.CONCRETE_REBAR.get());
                        output.accept(ModBlocks.CONCRETE_SMOOTH.get());
                        output.accept(ModBlocks.CONCRETE_SUPER_BROKEN.get());
                        output.accept(ModBlocks.DECO_ALUMINIUM.get());
                        output.accept(ModBlocks.DECO_ASBESTOS.get());
                        output.accept(ModBlocks.DECO_BERYLLIUM.get());
                        output.accept(ModBlocks.DECO_LEAD.get());
                        output.accept(ModBlocks.DECO_RBMK.get());
                        output.accept(ModBlocks.DECO_RBMK_SMOOTH.get());
                        output.accept(ModBlocks.DECO_RED_COPPER.get());
                        output.accept(ModBlocks.DECO_RUSTY_STEEL.get());
                        output.accept(ModBlocks.DECO_STEEL.get());
                        output.accept(ModBlocks.DECO_TITANIUM.get());
                        output.accept(ModBlocks.DECO_TUNGSTEN.get());
                        output.accept(ModBlocks.DEPTH_BRICK.get());
                        output.accept(ModBlocks.DEPTH_DNT.get());
                        output.accept(ModBlocks.DEPTH_NETHER_BRICK.get());
                        output.accept(ModBlocks.DEPTH_NETHER_TILES.get());
                        output.accept(ModBlocks.DEPTH_TILES.get());
                        output.accept(ModBlocks.DUCRETE.get());
                        output.accept(ModBlocks.DUCRETE_SMOOTH.get());
                        output.accept(ModBlocks.GNEISS_BRICK.get());
                        output.accept(ModBlocks.GNEISS_CHISELED.get());
                        output.accept(ModBlocks.GNEISS_TILE.get());
                        output.accept(ModBlocks.GRAVEL_DIAMOND.get());
                        output.accept(ModBlocks.GRAVEL_OBSIDIAN.get());
                        output.accept(ModBlocks.ORE_ALEXANDRITE.get());
                        output.accept(ModBlocks.ORE_ALUMINIUM.get());
                        output.accept(ModBlocks.ORE_ASBESTOS.get());
                        output.accept(ModBlocks.ORE_AUSTRALIUM.get());
                        output.accept(ModBlocks.ORE_BASALT.get());
                        output.accept(ModBlocks.ORE_BEDROCK.get());
                        output.accept(ModBlocks.ORE_BEDROCK_OIL.get());
                        output.accept(ModBlocks.ORE_BERYLLIUM.get());
                        output.accept(ModBlocks.ORE_CINNEBAR.get());
                        output.accept(ModBlocks.ORE_COBALT.get());
                        output.accept(ModBlocks.ORE_COLTAN.get());
                        output.accept(ModBlocks.ORE_COPPER.get());
                        output.accept(ModBlocks.ORE_DEPTH_BORAX.get());
                        output.accept(ModBlocks.ORE_DEPTH_CINNEBAR.get());
                        output.accept(ModBlocks.ORE_DEPTH_NETHER_NEODYMIUM.get());
                        output.accept(ModBlocks.ORE_DEPTH_ZIRCONIUM.get());
                        output.accept(ModBlocks.ORE_FLUORITE.get());
                        output.accept(ModBlocks.ORE_GNEISS_ASBESTOS.get());
                        output.accept(ModBlocks.ORE_GNEISS_COPPER.get());
                        output.accept(ModBlocks.ORE_GNEISS_GAS.get());
                        output.accept(ModBlocks.ORE_GNEISS_GOLD.get());
                        output.accept(ModBlocks.ORE_GNEISS_IRON.get());
                        output.accept(ModBlocks.ORE_GNEISS_LITHIUM.get());
                        output.accept(ModBlocks.ORE_GNEISS_RARE.get());
                        output.accept(ModBlocks.ORE_GNEISS_SCHRABIDIUM.get());
                        output.accept(ModBlocks.ORE_GNEISS_URANIUM.get());
                        output.accept(ModBlocks.ORE_GNEISS_URANIUM_SCORCHED.get());
                        output.accept(ModBlocks.ORE_LEAD.get());
                        output.accept(ModBlocks.ORE_LIGNITE.get());
                        output.accept(ModBlocks.ORE_METEOR.get());
                        output.accept(ModBlocks.ORE_NETHER_COAL.get());
                        output.accept(ModBlocks.ORE_NETHER_COBALT.get());
                        output.accept(ModBlocks.ORE_NETHER_FIRE.get());
                        output.accept(ModBlocks.ORE_NETHER_PLUTONIUM.get());
                        output.accept(ModBlocks.ORE_NETHER_SCHRABIDIUM.get());
                        output.accept(ModBlocks.ORE_NETHER_SMOLDERING.get());
                        output.accept(ModBlocks.ORE_NETHER_SULFUR.get());
                        output.accept(ModBlocks.ORE_NETHER_TUNGSTEN.get());
                        output.accept(ModBlocks.ORE_NETHER_URANIUM.get());
                        output.accept(ModBlocks.ORE_NETHER_URANIUM_SCORCHED.get());
                        output.accept(ModBlocks.ORE_NITER.get());
                        output.accept(ModBlocks.ORE_OIL.get());
                        output.accept(ModBlocks.ORE_OIL_EMPTY.get());
                        output.accept(ModBlocks.ORE_OIL_SAND.get());
                        output.accept(ModBlocks.ORE_RARE.get());
                        output.accept(ModBlocks.ORE_SCHRABIDIUM.get());
                        output.accept(ModBlocks.ORE_SULFUR.get());
                        output.accept(ModBlocks.ORE_THORIUM.get());
                        output.accept(ModBlocks.ORE_TIKITE.get());
                        output.accept(ModBlocks.ORE_TITANIUM.get());
                        output.accept(ModBlocks.ORE_TUNGSTEN.get());
                        output.accept(ModBlocks.ORE_URANIUM.get());
                        output.accept(ModBlocks.ORE_URANIUM_SCORCHED.get());
                        output.accept(ModBlocks.ORE_VOLCANO.get());
                        output.accept(ModBlocks.REINFORCED_BRICK.get());
                        output.accept(ModBlocks.REINFORCED_DUCRETE.get());
                        output.accept(ModBlocks.REINFORCED_SAND.get());
                        output.accept(ModBlocks.REINFORCED_STONE.get());
                        output.accept(ModBlocks.SANDBAGS.get());
                        output.accept(ModBlocks.STONE_BIOME.get());
                        output.accept(ModBlocks.STONE_DEPTH.get());
                        output.accept(ModBlocks.STONE_DEPTH_NETHER.get());
                        output.accept(ModBlocks.STONE_GNEISS.get());
                        output.accept(ModBlocks.STONE_KEYHOLE.get());
                        output.accept(ModBlocks.STONE_KEYHOLE_META.get());
                        output.accept(ModBlocks.STONE_POROUS.get());
                        output.accept(ModBlocks.STONE_RESOURCE.get());
                        output.accept(ModBlocks.TEST_BLOCK.get());
                        output.accept(ModBlocks.WOOD_BARRIER.get());
                        output.accept(ModBlocks.WOOD_STRUCTURE.get());
                    })
                    .build());
    ...
    public static final RegistryObject<CreativeModeTab> MACHINE_TAB =
            TABS.register("machines", () -> CreativeModeTab.builder()
                    ...
                    .displayItems((params, output) -> {
                        ...
                        output.accept(ModBlocks.CAPACITOR_BUS.get());
                        output.accept(ModBlocks.CAPACITOR_COPPER.get());
                        output.accept(ModBlocks.CAPACITOR_GOLD.get());
                        output.accept(ModBlocks.CAPACITOR_NIOBIUM.get());
                        output.accept(ModBlocks.CAPACITOR_SCHRABIDATE.get());
                        output.accept(ModBlocks.CAPACITOR_TANTALIUM.get());
                        output.accept(ModBlocks.FOUNDRY_BASIN.get());
                        output.accept(ModBlocks.FOUNDRY_CHANNEL.get());
                        output.accept(ModBlocks.FOUNDRY_MOLD.get());
                        output.accept(ModBlocks.FOUNDRY_OUTLET.get());
                        output.accept(ModBlocks.FOUNDRY_SLAGTAP.get());
                        output.accept(ModBlocks.FOUNDRY_TANK.get());
                        output.accept(ModBlocks.FURNACE_IRON.get());
                        output.accept(ModBlocks.FURNACE_STEEL.get());
                        output.accept(ModBlocks.FUSION_HEATER.get());
                        output.accept(ModBlocks.HEATER_ELECTRIC.get());
                        output.accept(ModBlocks.HEATER_FIREBOX.get());
                        output.accept(ModBlocks.ICF_LASER_CONTROLLER.get());
                        output.accept(ModBlocks.ITER.get());
                        output.accept(ModBlocks.LAMP_DEMON.get());
                        output.accept(ModBlocks.LAMP_TRITIUM_BLUE_OFF.get());
                        output.accept(ModBlocks.LAMP_TRITIUM_BLUE_ON.get());
                        output.accept(ModBlocks.LAMP_TRITIUM_GREEN_OFF.get());
                        output.accept(ModBlocks.LAMP_TRITIUM_GREEN_ON.get());
                        output.accept(ModBlocks.MACHINE_AMMO_PRESS.get());
                        output.accept(ModBlocks.MACHINE_ANNIHILATOR.get());
                        output.accept(ModBlocks.MACHINE_ARC_FURNACE.get());
                        output.accept(ModBlocks.MACHINE_ARC_WELDER.get());
                        output.accept(ModBlocks.MACHINE_ARMOR_TABLE.get());
                        output.accept(ModBlocks.MACHINE_ASSEMBLY_FACTORY.get());
                        output.accept(ModBlocks.MACHINE_ASSEMBLY_MACHINE.get());
                        output.accept(ModBlocks.MACHINE_AUTOCRAFTER.get());
                        output.accept(ModBlocks.MACHINE_AUTOSAW.get());
                        output.accept(ModBlocks.MACHINE_BAT9000.get());
                        output.accept(ModBlocks.MACHINE_BATTERY_POTATO.get());
                        output.accept(ModBlocks.MACHINE_BATTERY_REDD.get());
                        output.accept(ModBlocks.MACHINE_BATTERY_SOCKET.get());
                        output.accept(ModBlocks.MACHINE_BOILER.get());
                        output.accept(ModBlocks.MACHINE_CASING.get());
                        output.accept(ModBlocks.MACHINE_CATALYTIC_CRACKER.get());
                        output.accept(ModBlocks.MACHINE_CATALYTIC_REFORMER.get());
                        output.accept(ModBlocks.MACHINE_CENTRIFUGE.get());
                        output.accept(ModBlocks.MACHINE_CHEMICAL_FACTORY.get());
                        output.accept(ModBlocks.MACHINE_CHEMICAL_PLANT.get());
                        output.accept(ModBlocks.MACHINE_CHUNGUS.get());
                        output.accept(ModBlocks.MACHINE_COKER.get());
                        output.accept(ModBlocks.MACHINE_COMBUSTION_ENGINE.get());
                        output.accept(ModBlocks.MACHINE_COMPRESSOR.get());
                        output.accept(ModBlocks.MACHINE_COMPRESSOR_ELECTRIC.get());
                        output.accept(ModBlocks.MACHINE_CONDENSER.get());
                        output.accept(ModBlocks.MACHINE_CONTROLLER.get());
                        output.accept(ModBlocks.MACHINE_CONVERTER_HE_RF.get());
                        output.accept(ModBlocks.MACHINE_CONVERTER_RF_HE.get());
                        output.accept(ModBlocks.MACHINE_CONVEYOR_PRESS.get());
                        output.accept(ModBlocks.MACHINE_CRUCIBLE.get());
                        output.accept(ModBlocks.MACHINE_CRYSTALLIZER.get());
                        output.accept(ModBlocks.MACHINE_CYCLOTRON.get());
                        output.accept(ModBlocks.MACHINE_DETECTOR.get());
                        output.accept(ModBlocks.MACHINE_DEUTERIUM_EXTRACTOR.get());
                        output.accept(ModBlocks.MACHINE_DEUTERIUM_TOWER.get());
                        output.accept(ModBlocks.MACHINE_DIESEL.get());
                        output.accept(ModBlocks.MACHINE_DIFURNACE_OFF.get());
                        output.accept(ModBlocks.MACHINE_DIFURNACE_ON.get());
                        output.accept(ModBlocks.MACHINE_DINEUTRONIUM_BATTERY.get());
                        output.accept(ModBlocks.MACHINE_DRAIN.get());
                        output.accept(ModBlocks.MACHINE_ELECTRIC_FURNACE_OFF.get());
                        output.accept(ModBlocks.MACHINE_ELECTRIC_FURNACE_ON.get());
                        output.accept(ModBlocks.MACHINE_ELECTROLYSER.get());
                        output.accept(ModBlocks.MACHINE_EPRESS.get());
                        output.accept(ModBlocks.MACHINE_EXCAVATOR.get());
                        output.accept(ModBlocks.MACHINE_EXPOSURE_CHAMBER.get());
                        output.accept(ModBlocks.MACHINE_FEL.get());
                        output.accept(ModBlocks.MACHINE_FENSU.get());
                        output.accept(ModBlocks.MACHINE_FLUIDTANK.get());
                        output.accept(ModBlocks.MACHINE_FORCEFIELD.get());
                        output.accept(ModBlocks.MACHINE_FRACKING_TOWER.get());
                        output.accept(ModBlocks.MACHINE_FRACTION_TOWER.get());
                        output.accept(ModBlocks.MACHINE_FUNNEL.get());
                        output.accept(ModBlocks.MACHINE_FURNACE_BRICK_OFF.get());
                        output.accept(ModBlocks.MACHINE_FURNACE_BRICK_ON.get());
                        output.accept(ModBlocks.MACHINE_GASCENT.get());
                        output.accept(ModBlocks.MACHINE_HEPHAESTUS.get());
                        output.accept(ModBlocks.MACHINE_HYDROTREATER.get());
                        output.accept(ModBlocks.MACHINE_ICF_PRESS.get());
                        output.accept(ModBlocks.MACHINE_INDUSTRIAL_GENERATOR.get());
                        output.accept(ModBlocks.MACHINE_INDUSTRIAL_TURBINE.get());
                        output.accept(ModBlocks.MACHINE_INTAKE.get());
                        output.accept(ModBlocks.MACHINE_KEYFORGE.get());
                        output.accept(ModBlocks.MACHINE_LARGE_TURBINE.get());
                        output.accept(ModBlocks.MACHINE_LIQUEFACTOR.get());
                        output.accept(ModBlocks.MACHINE_LITHIUM_BATTERY.get());
                        output.accept(ModBlocks.MACHINE_LPW2.get());
                        output.accept(ModBlocks.MACHINE_MICROWAVE.get());
                        output.accept(ModBlocks.MACHINE_MINING_LASER.get());
                        output.accept(ModBlocks.MACHINE_MINIRTG.get());
                        output.accept(ModBlocks.MACHINE_MISSILE_ASSEMBLY.get());
                        output.accept(ModBlocks.MACHINE_MIXER.get());
                        output.accept(ModBlocks.MACHINE_ORBUS.get());
                        output.accept(ModBlocks.MACHINE_ORE_SLOPPER.get());
                        output.accept(ModBlocks.MACHINE_POWERRTG.get());
                        output.accept(ModBlocks.MACHINE_PRECASS.get());
                        output.accept(ModBlocks.MACHINE_PRESS.get());
                        output.accept(ModBlocks.MACHINE_PUF6_TANK.get());
                        output.accept(ModBlocks.MACHINE_PUMPJACK.get());
                        output.accept(ModBlocks.MACHINE_PUREX.get());
                        output.accept(ModBlocks.MACHINE_PYROOVEN.get());
                        output.accept(ModBlocks.MACHINE_RADAR.get());
                        output.accept(ModBlocks.MACHINE_RADAR_LARGE.get());
                        output.accept(ModBlocks.MACHINE_RADGEN.get());
                        output.accept(ModBlocks.MACHINE_RADIOLYSIS.get());
                        output.accept(ModBlocks.MACHINE_REACTOR_BREEDING.get());
                        output.accept(ModBlocks.MACHINE_REFINERY.get());
                        output.accept(ModBlocks.MACHINE_ROTARY_FURNACE.get());
                        output.accept(ModBlocks.MACHINE_RTG_GREY.get());
                        output.accept(ModBlocks.MACHINE_SATLINKER.get());
                        output.accept(ModBlocks.MACHINE_SAWMILL.get());
                        output.accept(ModBlocks.MACHINE_SCHRABIDIUM_BATTERY.get());
                        output.accept(ModBlocks.MACHINE_SHREDDER.get());
                        output.accept(ModBlocks.MACHINE_SILEX.get());
                        output.accept(ModBlocks.MACHINE_SIREN.get());
                        output.accept(ModBlocks.MACHINE_SOLAR_BOILER.get());
                        output.accept(ModBlocks.MACHINE_SOLDERING_STATION.get());
                        output.accept(ModBlocks.MACHINE_SOLIDIFIER.get());
                        output.accept(ModBlocks.MACHINE_STEAM_ENGINE.get());
                        output.accept(ModBlocks.MACHINE_STIRLING_GENERATOR_OFF.get());
                        output.accept(ModBlocks.MACHINE_STIRLING_GENERATOR_ON.get());
                        output.accept(ModBlocks.MACHINE_STIRLING_OFF.get());
                        output.accept(ModBlocks.MACHINE_STIRLING_ON.get());
                        output.accept(ModBlocks.MACHINE_STORAGE_DRUM.get());
                        output.accept(ModBlocks.MACHINE_STRAND_CASTER.get());
                        output.accept(ModBlocks.MACHINE_TELEPORTER.get());
                        output.accept(ModBlocks.MACHINE_TOWER_LARGE.get());
                        output.accept(ModBlocks.MACHINE_TOWER_SMALL.get());
                        output.accept(ModBlocks.MACHINE_TRANSFORMER.get());
                        output.accept(ModBlocks.MACHINE_TURBINE.get());
                        output.accept(ModBlocks.MACHINE_TURBINEGAS.get());
                        output.accept(ModBlocks.MACHINE_TURBOFAN.get());
                        output.accept(ModBlocks.MACHINE_UF6_TANK.get());
                        output.accept(ModBlocks.MACHINE_VACUUM_DISTILL.get());
                        output.accept(ModBlocks.MACHINE_WASTE_DRUM.get());
                        output.accept(ModBlocks.MACHINE_WEAPON_TABLE.get());
                        output.accept(ModBlocks.MACHINE_WELL.get());
                        output.accept(ModBlocks.MACHINE_WOOD_BURNER.get());
                        output.accept(ModBlocks.PLASMA_HEATER.get());
                        output.accept(ModBlocks.PRESS_PREHEATER.get());
                        output.accept(ModBlocks.PUMP_ELECTRIC.get());
                        output.accept(ModBlocks.PUMP_STEAM.get());
                        output.accept(ModBlocks.RBMK_ABSORBER.get());
                        output.accept(ModBlocks.RBMK_AUTOLOADER.get());
                        output.accept(ModBlocks.RBMK_BLANK.get());
                        output.accept(ModBlocks.RBMK_BOILER.get());
                        output.accept(ModBlocks.RBMK_CONSOLE.get());
                        output.accept(ModBlocks.RBMK_CONTROL.get());
                        output.accept(ModBlocks.RBMK_CONTROL_AUTO.get());
                        output.accept(ModBlocks.RBMK_CONTROL_MOD.get());
                        output.accept(ModBlocks.RBMK_COOLER.get());
                        output.accept(ModBlocks.RBMK_CRANE_CONSOLE.get());
                        output.accept(ModBlocks.RBMK_HEATER.get());
                        output.accept(ModBlocks.RBMK_LOADER.get());
                        output.accept(ModBlocks.RBMK_MODERATOR.get());
                        output.accept(ModBlocks.RBMK_OUTGASSER.get());
                        output.accept(ModBlocks.RBMK_REFLECTOR.get());
                        output.accept(ModBlocks.RBMK_ROD.get());
                        output.accept(ModBlocks.RBMK_ROD_MOD.get());
                        output.accept(ModBlocks.RBMK_ROD_REASIM.get());
                        output.accept(ModBlocks.RBMK_ROD_REASIM_MOD.get());
                        output.accept(ModBlocks.RBMK_STEAM_INLET.get());
                        output.accept(ModBlocks.RBMK_STORAGE.get());
                        output.accept(ModBlocks.REACTOR_RESEARCH.get());
                        output.accept(ModBlocks.REACTOR_ZIRNOX.get());
                        output.accept(ModBlocks.REINFORCED_LAMP_OFF.get());
                        output.accept(ModBlocks.REINFORCED_LAMP_ON.get());
                        output.accept(ModBlocks.REINFORCED_LIGHT.get());
                    })
                    .build());
